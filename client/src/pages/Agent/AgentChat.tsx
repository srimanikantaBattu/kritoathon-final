...
function AgentChat() {
  ...
  return (
    <div className="flex ps-52 ">


   
    <div className="w-3/5 flex flex-col h-[calc(100vh-4rem)] max-w-xl mx-auto px-4 pb-2">

        
    
      <div className="flex items-center justify-center mb-4 border-b pb-3">
        <h1 className="text-2xl font-bold">Chat with Buyer : </h1>
        <h2 className="text-2xl font-bold">{buyerName}</h2>
      </div>
          ...
          <div className="flex flex-col space-y-4">
            {messages.length > 0 ? (
              messages.map((msg:any, index) => (
                <div key={index} className={`flex ${msg.type === "agent" ? "justify-end" : "justify-start"}`}>
                  <div
    ...
    <div className="w-2/5">
    <Button onClick={() => window.open('https://websigmas.vercel.app', '_blank')}>
  Start video Chat
</Button>
    </div>
    </div>
